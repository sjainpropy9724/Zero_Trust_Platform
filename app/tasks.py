...
# Configure Celery. The broker URL points to our Redis container.
# The 'app' name is the name of the current module.
...
def scan_file_task(file_id: int):
    ...
    try:
        ...
        # For now, we'll only handle simple text files
        # We will add support for .docx, .pdf etc. later
        ...
        if file_suffix in [".txt", ".docx", ".pdf"]:
            ...
            # For Excel, scan cell by cell to provide exact locations
        ...
        # Implement granular classification logic
